...
new class extends Component {
    public $nama_pegawai, $departemen_id, $jabatan, $nomor_telepon, $tanggal_bergabung, $pegawai_id;
    public $isEdit = false;
    ...
    {
        $this->reset(['nama_pegawai', 'departemen_id', 'jabatan', 'nomor_telepon', 'tanggal_bergabung', 'pegawai_id', 'isEdit']);
    }
