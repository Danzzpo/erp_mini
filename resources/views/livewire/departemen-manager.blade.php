<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="fw-bold text-primary"><i class="bi bi-building"></i> Manajemen Departemen (HRD)</h3>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white fw-bold">
                    @if($isEdit)
                        <i class="bi bi-pencil-square"></i> Edit Departemen
                    @else
                ...
                <div class="card-body bg-light">
                    <form wire:submit.prevent="simpan">
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="nama_departemen" class="form-control" placeholder="Contoh: IT, Keuangan, Marketing...">
                                ...
                                @forelse($departemens as $index => $dept)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button wire:click="edit({{ $dept->id }})" class="btn btn-warning btn-sm fw-bold text-dark shadow-sm">
                                                <i class="bi bi-pencil"></i> Edit
                                            </button>
                                            <button wire:click="hapus({{ $dept->id }})" class="btn btn-danger btn-sm fw-bold shadow-sm">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">
                                            <em>Belum ada data departemen.</em>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
